...
watercolors3 = ArtClass.create!(title: "Watercolor Portraits", description: "Learn to paint expressive portraits in watercolor. This class covers facial proportions, skin tone blending, and capturing emotions with soft washes and bold details. Designed for intermediate learners.", price: 5500, category: "Watercolor", location: "日本, 〒153-0063 東京都目黒区 目黒#{rand(1..3)}丁目#{rand(1..10)}番#{rand(1..3)}号", dates: "25/02/10", user: pedro)
...
manga = ArtClass.create!(title: "Manga Drawing Basics", description: "Dive into the world of manga by learning the basics of character design, facial expressions, and proportions. This beginner-friendly class is perfect for aspiring manga artists.", price: 4000, category: "Manga", location: "日本, 〒153-0063 東京都目黒区 目黒#{rand(1..3)}丁目#{rand(1..10)}番#{rand(1..3)}号", dates: "25/02/18", user: sakura)
...
diy3 = ArtClass.create!(title: "DIY Home Decor Projects", description: "Get creative with DIY projects for your home. Learn to make stylish wall hangings, personalized coasters, and decorative items that add charm to your space.", price: 3800, category: "DIY", location: "日本, 〒153-0063 東京都目黒区 目黒#{rand(1..3)}丁目#{rand(1..10)}番#{rand(1..3)}号", dates: "24/12/03", user: james)
...
sculpture2 = ArtClass.create!(title: "Abstract Sculptures", description: "Explore your creativity by designing and building abstract sculptures. Learn how to manipulate clay and mixed materials to craft visually striking, modern art pieces.", price: 5500, category: "Sculpture", location: "日本, 〒153-0063 東京都目黒区 目黒#{rand(1..3)}丁目#{rand(1..10)}番#{rand(1..3)}号", dates: "25/01/12", user: paula)
